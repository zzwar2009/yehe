...
@connect(
    state => {
        return {
            dataList: state.replyfactory.dataList,
            pageIndex: state.replyfactory.pageIndex,
            totalCount: state.replyfactory.totalCount,
    ...
    render() {
        ...
        const addAction = (
            <div style={{ display: 'flex', flexDirection: 'row' }}>
                <span style={{ fontSize: 20, fontWeight: 'bold', display: 'flex' }}>回复工厂</span>
                <Button
                    type="primary"
                    style={{ marginLeft: 20 }}
